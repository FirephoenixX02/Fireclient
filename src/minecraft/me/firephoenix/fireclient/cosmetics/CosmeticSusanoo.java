...
public class CosmeticSusanoo extends CosmeticBase {
  ...
  public void render(AbstractClientPlayer player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
   ...
   class NAME2 extends CosmeticModelBase {
    ...
    public void render(AbstractClientPlayer player, Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float headYaw, float headPitch, float scale) {
        GlStateManager.pushMatrix();
