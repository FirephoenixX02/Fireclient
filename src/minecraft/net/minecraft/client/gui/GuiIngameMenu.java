...
import me.firephoenix.fireclient.ui.GuiMultiplayerIngame;
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 1:
                ...
                if (flag)
                {
                    this.mc.displayGuiScreen(new FireclientMainMenu());
                }
                else if (flag1)
                {
                    RealmsBridge realmsbridge = new RealmsBridge();
                    realmsbridge.switchToRealms(new FireclientMainMenu());
                }
                else
                {
                    this.mc.displayGuiScreen(new GuiMultiplayer(new FireclientMainMenu()));
                }
