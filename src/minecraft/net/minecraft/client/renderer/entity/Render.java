...
public abstract class Render<T extends Entity> {
	...
	protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
		...
		if (d0 <= (double) (maxDistance * maxDistance)) {
			...
			/**
			 * Render Owner Label before Player Name
			 */

			if (entityIn instanceof AbstractClientPlayer) {
				if (entityIn.getName().equals("NieGestorben")) {
			...
			if (entityIn instanceof AbstractClientPlayer) {
				if (entityIn.getName().equals("DerEchteSaft") || entityIn.getName().equals("wichtigesLego")) {
					Minecraft.getMinecraft().getTextureManager()
			...
			/**
			 * Render Manager Label before Player Name
			 */

			if (entityIn instanceof AbstractClientPlayer) {
				if (entityIn.getName().equals("billigesBrot")) {
					Minecraft.getMinecraft().getTextureManager()
			 ...
			 */
			/**
			 * Render Placement Label before Player Name
			 */

			if (entityIn instanceof AbstractClientPlayer) {
				if (entityIn.getName().equals("flixAmSoupen") || entityIn.getName().equals("Rcfill")
						|| entityIn.getName().equals("Kleinhummel") || entityIn.getName().equals("LaurinVL")
						|| entityIn.getName().equals("Xaratas")) {
					Minecraft.getMinecraft().getTextureManager()
