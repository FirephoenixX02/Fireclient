...
import me.firephoenix.fireclient.ui.FireclientMainMenu;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                GlStateManager.rotate(Fireclient.INSTANCE.hudManager.perspective.getCameraYaw() + (entity.rotationYaw - Fireclient.INSTANCE.hudManager.perspective.getCameraYaw()) * partialTicks + 180.0F, 0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(Fireclient.INSTANCE.hudManager.perspective.getCameraPitch() + (entity.rotationPitch - Fireclient.INSTANCE.hudManager.perspective.getCameraPitch()) * partialTicks, -1.0F, 0.0F, 0.0F);
            }
        }
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists())
        {
            if (!this.mc.gameSettings.debugCamEnable)
            {
                float f6 = Fireclient.INSTANCE.hudManager.perspective.getCameraYaw() + (entity.rotationYaw - Fireclient.INSTANCE.hudManager.perspective.getCameraYaw()) * partialTicks + 180.0F;
                float f7 = Fireclient.INSTANCE.hudManager.perspective.getCameraPitch() + (entity.rotationPitch - Fireclient.INSTANCE.hudManager.perspective.getCameraPitch()) * partialTicks;
                float f8 = 0.0F;
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_)
    {
        ...
        if (this.mc.inGameHasFocus && flag && Fireclient.INSTANCE.hudManager.perspective.overrideMouse())
        {
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof FireclientMainMenu)
        {
            this.updateMainMenu((FireclientMainMenu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(FireclientMainMenu p_updateMainMenu_1_)
    {
        try
        {
            String s = null;
            ...
            Field[] afield = FireclientMainMenu.class.getDeclaredFields();
