...
import me.firephoenix.fireclient.event.impl.KeyEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new FireclientMainMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new FireclientMainMenu());
        }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new FireclientMainMenu();
        }
        ...
        if (guiScreenIn instanceof FireclientMainMenu)
        {
